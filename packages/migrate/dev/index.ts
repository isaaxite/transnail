import { migratePrompt, Migrater } from "../index";
import { DestAssetStruct } from "../src/constants";
import { printResult } from "../src/utils";

const baseAbsPath = '/home/isaac/Workspace/';

async function main() {
  // const ret1 = await migratePrompt(baseAbsPath, 'blog/source/_drafts', {
  //   prompt: {
  ...
  // const ret2 = await migratePrompt(baseAbsPath, 'blog/source/_posts', {
  //   prompt: {
